...
<section class="content">
    <form action="<?php echo site_url('penerbit/prosesTambah') ?>" method="post">
        <!-- Default box -->
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="no_telp" name="no_telp" placeholder="Nomer Telpon Penerbit">
                </div>
            </div>
            <!-- /.card-body -->
